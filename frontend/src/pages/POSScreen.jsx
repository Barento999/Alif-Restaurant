          ...
          <div className="flex flex-col md:flex-row gap-4 mb-6">
            <div className="flex-1 relative">
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0d5f4e]"
              />
              <svg
            ...
            <select
              ...
              className="px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0d5f4e]">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 sticky top-6">
          ...
          <div className="mb-4">
            ...
            <select
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0d5f4e]">
          ...
          <textarea
            ...
            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0d5f4e] mb-4"
            rows="2"
          />
          ...
          <div className="mt-6 space-y-3">
            <button
              ...
              className="w-full bg-[#0d5f4e] text-white py-3 rounded-xl font-semibold hover:bg-[#0f7a62] disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:scale-[1.02]">
              Place Order
            </button>
            <button
              onClick={() => setCart([])}
